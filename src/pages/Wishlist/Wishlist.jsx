...
const Wishlist = () => {
    ...
    const { addToCart, removeFromCart, removeFromWishlist, cart, wishlist } = useProductStore();

    const handleCartToggle = (productId) => {
        const isInCart = cart.find(item => item.id === productId);

        if (!isInCart) {
            addToCart(wishlist.find(item => item.id === productId));
        } else {
                            ...
                            <table className="min-w-full bg-white rounded-lg shadow-md">
                                <thead>
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 text-center text-gray-500 font-medium">View</th>
                                    </tr>
                                </thead>
                                <tbody>
